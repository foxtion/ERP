    ...
    <div v-if="detail" class="detail-wrap">
      <div class="info-card">
        <div class="detail-header">
          <div class="detail-name">{{ detail.product_name }}</div>
          <van-tag type="primary">v{{ detail.version }}</van-tag>
        </div>
        <div class="meta-info">
          <div class="meta-item">
          ...
          <div class="meta-item">
            ...
            <van-tag :type="detail.is_active ? 'success' : 'danger'" size="small">
      ...
      <div class="section-title">BOM明细（{{ detail.items?.length || 0 }}）</div>
      <div class="item-list">
...
import { getBomDetail } from '@/api/production'
