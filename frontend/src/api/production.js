...
export function copyBom(id) {
  return request({ url: `/production/boms/${id}/copy/`, method: 'post' })
}
...
export function cancelPlan(id) {
  return request({ url: `/production/plans/${id}/cancel/`, method: 'post' })
}
export function createOrderFromPlan(id) {
  return request({ url: `/production/plans/${id}/order/`, method: 'post' })
}
...
export function releaseWorkOrder(id) {
  return request({ url: `/production/orders/${id}/release/`, method: 'post' })
}
export function startWorkOrder(id) {
  return request({ url: `/production/orders/${id}/start/`, method: 'post' })
}
export function completeWorkOrder(id) {
  return request({ url: `/production/orders/${id}/complete/`, method: 'post' })
}
export function cancelWorkOrder(id) {
  return request({ url: `/production/orders/${id}/cancel/`, method: 'post' })
}
export function createRequisitionFromOrder(id) {
  return request({ url: `/production/orders/${id}/requisition/`, method: 'post' })
}
export function createInStockFromOrder(id) {
  return request({ url: `/production/orders/${id}/instock/`, method: 'post' })
}
...
export function submitRequisition(id) {
  return request({ url: `/production/requisitions/${id}/submit/`, method: 'post' })
}
export function approveRequisition(id) {
  return request({ url: `/production/requisitions/${id}/approve/`, method: 'post' })
}
export function issueRequisition(id) {
  return request({ url: `/production/requisitions/${id}/issue/`, method: 'post' })
}
export function cancelRequisition(id) {
  return request({ url: `/production/requisitions/${id}/cancel/`, method: 'post' })
}
...
export function submitProductionInStock(id) {
  return request({ url: `/production/instocks/${id}/submit/`, method: 'post' })
}
export function approveProductionInStock(id) {
  return request({ url: `/production/instocks/${id}/approve/`, method: 'post' })
}
export function confirmProductionInStock(id) {
  return request({ url: `/production/instocks/${id}/confirm/`, method: 'post' })
}
export function cancelProductionInStock(id) {
  return request({ url: `/production/instocks/${id}/cancel/`, method: 'post' })
}
